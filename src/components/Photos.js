...
import PhotosImg from "../PhotosImg.webp";
    ...
    <>
      <nav className="navbar background">
        ...
        <ul className="nav-right">
          ...
          <li>
            <Link Link to="/components/Signin">
      ...
      <nav className="navbar background">
        <ul className="nav-list">
          ...
          <li>
            <Link to="/components/Photos" style={photos}>
              Photos
            </Link>
          </li>
        </ul>
      ...
      <section className="background firstsection">
        <div className="box-main">
          <div className="firsthalf">
            <p class="text-big">Royalty free stock photos from $2</p>
            <p class="text-small">
          ...
          <div className="secondhalf">
            <img src={PhotosImg} alt="sideimage" style={imageStyle}/>
          </div>
        </div>
      </section>
